...
@JsonSubTypes(
    ...
    JsonSubTypes.Type(value = FftAmplitudeViewLayerDef::class, name = "fft-amplitude-view"),
)
open class LayerDef(
    val name: String,
...
class FftAmplitudeViewLayerDef(
    @JsonProperty(required = true) val `in`: Int,
    name: String = "fft-layer",
    outputVarName: String?,
    inputVariables: List<String>?,
    @JsonProperty(required = true) val inputExpression: String,
): LayerDef(name, outputVarName, inputVariables)

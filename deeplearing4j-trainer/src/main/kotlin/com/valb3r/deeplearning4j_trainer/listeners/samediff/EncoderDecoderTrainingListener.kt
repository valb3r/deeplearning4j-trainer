...
class EncoderDecoderTrainingListener(
    ...
    override fun iterationDone(sd: SameDiff, at: At, dataSet: MultiDataSet, loss: Loss?) {
        ...
        val batchPointZero = dataSet.features[0].get(NDArrayIndex.point(0))
        ...
        val output = sd.output(dataSet, outputVarName)[outputVarName]!!.get(NDArrayIndex.point(0))!!.toDoubleVector()
        makeChart(
            mapOf(
